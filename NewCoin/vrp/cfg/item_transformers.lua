...
cfg.item_transformers = {
  -- example of harvest item transformer
    ...
    recipes = {
     ...
     {
    name="Diamante Exchange", -- menu name
    r=50,g=15,b=255, -- color
    max_units=100000,
    units_per_minute=100000,
	-- -261.71527099609,-975.57556152344,31.219696044922
    x=-261.71527099609,y=-975.57556152344,z=31.219696044922, --coords (Pacific Bank)
    radius=1, height=1.5, -- area
    recipes = {
      ["Change Diamante"] = { -- action name
        description="Cumpara Diamante", -- action description
        in_money=1000000, -- $ taken per unit
	in_diamante=0, -- Euros taken per unit
        out_money=0, --$ earned
        out_diamante=1, -- Euros earned per unit
        reagents={}, -- items taken per unit
        products={}
      }
	 }
       ...
       {
    name="Money Exchange", -- menu name
    r=50,g=15,b=255, -- color
    max_units=100000,
    units_per_minute=100000,
	-- -258.68417358398,-973.96234130859,31.220010757446
    x=-258.68417358398,y=-973.96234130859,z=31.220010757446, --coords (Pacific Bank)
    radius=1, height=1.5, -- area
    recipes = {
      ["Change Money"] = { -- action name
        description="Vine Diamante", -- action description
        in_money=0, -- $ taken per unit
	in_diamante=1, -- Euros taken per unit
        out_money=1000000, --$ earned
        out_diamante=0, -- Euros earned per unit
        reagents={}, -- items taken per unit
        products={}
      }
	 }
